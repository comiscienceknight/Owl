...
namespace OwlBatAzureMobileService.Models
{
    ...
    partial void DeleteMessageUserPair(MessageUserPair instance);
		...
		public int InsertAnMessage([global::System.Data.Linq.Mapping.ParameterAttribute(Name="Message", DbType="VarChar(250)")] string message, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="PairId", DbType="VarChar(128)")] string pairId)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), message, pairId);
			return ((int)(result.ReturnValue));
		}
	}
